package com.briancheruiyot.jobportal.aspects;

import com.briancheruiyot.jobportal.dto.RegisterRequestDto;
import com.briancheruiyot.jobportal.entity.JobPortalUser;
import com.briancheruiyot.jobportal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
            execution(* com.briancheruiyot.jobportal.auth.AuthController
            .registerUser(..))
            """)
