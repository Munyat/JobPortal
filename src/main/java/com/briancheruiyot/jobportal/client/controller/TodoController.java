package com.briancheruiyot.jobportal.client.controller;

import com.briancheruiyot.jobportal.client.service.RestClientTodoService;
import com.briancheruiyot.jobportal.client.service.TodoService;
import com.briancheruiyot.jobportal.dto.TodoDto;
...
public class TodoController {
    ...
    ResponseEntity<TodoDto> create(@RequestBody TodoDto toDoDto) {
        // return
        // ResponseEntity.status(HttpStatus.CREATED).body(restClientTodoService.create(toDoDto));
    ...
    ResponseEntity<TodoDto> update(@PathVariable Long id, @RequestBody TodoDto toDoDto) {
        // return
        // ResponseEntity.status(HttpStatus.OK).body(restClientTodoService.update(id,
        // toDoDto));
