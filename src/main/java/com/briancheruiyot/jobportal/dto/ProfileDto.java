...
public record ProfileDto(
        ...
        @NotBlank(message = "Experience level is required") @Size(max = 50) String experienceLevel,

        @NotBlank(message = "Professional bio is required") String professionalBio,

        @Size(max = 500) String portfolioWebsite,
