package com.briancheruiyot.jobportal.security.util;
        ...
        public String generateJwtToken(Authentication authentication) {
                ...
                jwtToken = Jwts.builder().issuer(jwtIssuer).subject(jwtSubject)
                                ...
                                .expiration(new java.util.Date(
                                                (new java.util.Date()).getTime() + expirationHours * 60 * 60 * 1000))
...
// GrantedAuthority::getAuthority).collect(Collectors.joining(",")))
// .issuedAt(new java.util.Date())
// .expiration(new java.util.Date((new java.util.Date()).getTime() + 24 * 60 *
// 60 * 1000))
// .signWith(secretKey).compact();
// return jwtToken;
// }
