package com.briancheruiyot.jobportal.user.controller;

import com.briancheruiyot.jobportal.dto.ApplyJobRequestDto;
...
import com.briancheruiyot.jobportal.user.service.IUserService;
...
public class UserController {
    ...
    public ResponseEntity<byte[]> getProfilePicture(Authentication authentication) {
        String userEmail = authentication.getName();
        com.briancheruiyot.jobportal.dto.ProfileDto profileDto = userService.getProfilePicture(userEmail);
    ...
    public ResponseEntity<byte[]> getResume(Authentication authentication) {
        String userEmail = authentication.getName();
        com.briancheruiyot.jobportal.dto.ProfileDto profileDto = userService.getResume(userEmail);
